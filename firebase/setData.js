...
class FirebaseData {
  ...
  static async appFind(data) {
    ...
    for (let i = 0; i < appoinment.length; i++) {
      if (appoinment[i].name != "") {
        if (appoinment[i].name == data.name) {
          console.log(appoinment[i].name, " - ", data.name);
          return appoinment[i];
        }
      }
      if (appoinment[i].email != "") {
        if (appoinment[i].email == data.email) {
          console.log(appoinment[i].name, " - ", data.name);
          return appoinment[i];
        }
      }
      if (appoinment[i].phone != "") {
        if (appoinment[i].phone == data.phone) {
          console.log(appoinment[i].name, " - ", data.name);
          return appoinment[i];
        }
      }
